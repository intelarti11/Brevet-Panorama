...
console.log("ULTRA_MINIMAL_V9_LOG: Top of index.ts. Attempting to load. Region: europe-west1");

export const ultraMinimalFunction = onCall(
  { region: "europe-west1" }, // Spécifier la région est une bonne pratique
  (request) => {
    logger.info("ULTRA_MINIMAL_V9_LOG: ultraMinimalFunction was called.", { structuredData: true, data: request.data });
    return {
      success: true,
...
console.log("ULTRA_MINIMAL_V9_LOG: End of index.ts. ultraMinimalFunction defined.");
